                ...
                <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="pt-4 flex justify-end">
                            ...
                            >
                                <svg className="w-5 h-5 stroke-current fill-none"><use href={`${import.meta.env.BASE_URL}sprites.svg#icon-check-2`} /></svg>
                                Guardar Cambios
                            </button>
                        </div>
                    </form>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <form onSubmit={handlePasswordChange} className="space-y-4 max-w-2xl">
                    ...
                    <div className="pt-4 flex justify-end">
                        ...
                        >
                            <svg className="w-5 h-5 stroke-current fill-none"><use href={`${import.meta.env.BASE_URL}sprites.svg#icon-lock`} /></svg>
                            Cambiar Contraseña
                        </button>
                    </div>
                </form>
